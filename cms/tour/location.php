...
$fields = array('id', 'location', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Location' => 4, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 2);//Column title and width
